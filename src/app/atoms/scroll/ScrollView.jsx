...
const ScrollView = React.forwardRef(({
  horizontal, vertical, autoHide, invisible, focusable, onScroll, children,
}, ref) => {
  ...
  return (
    <div onScroll={onScroll} ref={ref} className={`scrollbar${scrollbarClasses}`} tabIndex={focusable ? undefined : -1}>
      {children}
    </div>
  );
});
